...
<body>
    ...
    <div class="title">
        ...
        <a href="logout.php" style="color: 99CCFF; text-decoration:none;"><span class="fa fa-sign-out"></span> Logout</a>
    </div>
    ...
    <div class="nav">
        <ul>
            ...
            <li class="dropdown" onclick="toggleDisplay('1')">
                <a href="" class="dropbtn resp">Classes &nbsp
            ...
            <li class="dropdown" onclick="toggleDisplay('2')">
                <a href="#" class="dropbtn resp">Students &nbsp
                    <span class="fa fa-angle-down"></span>
                </a>
            ...
            <li class="dropdown" onclick="toggleDisplay('3')">
                <a href="#" class="dropbtn resp">Results &nbsp
                    <span class="fa fa-angle-down"></span>
                </a>
...
<div class="container">
    ...
    <div class="img1">
      <img src="images\urban-working-remotely.png" alt="" class="img">
    </div>
</div>
</body>
</html>
